...
public final class TextureSliced2D implements ITexture2D, IGlDisposable
{
    ...
    public TextureSliced2D(int x, int y, int width, int height, int glTextureID, float minU, float maxU, float minV, float maxV)
    {
        this.x = x;
        this.y = y;
        this.width = width;
